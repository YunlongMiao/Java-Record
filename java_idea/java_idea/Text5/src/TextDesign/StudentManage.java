...
public class StudentManage {
    ...
    //IO输出流：写文件
    public static void writeData(String fileName, ArrayList<Student> array) throws IOException {//抛出IOException异常
        //创建输入缓冲流对象
    ...
    //查看所有学生
    public static void findAllStudent(String fileName) throws IOException {//抛出IOException异常
