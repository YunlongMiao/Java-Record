...
<%@ page import="commyl.dao.BookDAO" %>
<%@ page import="commyl.dao.BookTypeDAO" %>
<%@ page import="commyl.actionForm.BookForm" %>
<%@ page import="commyl.actionForm.BookTypeForm"%>
<%@ page import="commyl.dao.BookCaseDAO" %>
<%@ page import="commyl.actionForm.BookCaseForm" %>
<%@ page import="commyl.dao.PublishingDAO" %>
<%@ page import="commyl.actionForm.PublishingForm" %>
